 ...
 public:
  ...
  [[__nodiscard__]] auto MinimumTokens(Pos pos = {0, 0}) const noexcept -> int64_t {
    ...
    */
    ...
    int64_t a1 = button_a_delta_.row;
    int64_t a2 = button_a_delta_.col;
    int64_t b1 = button_b_delta_.row;
    int64_t b2 = button_b_delta_.col;
    int64_t c1 = prize_pos_.row + 10000000000000;
    int64_t c2 = prize_pos_.col + 10000000000000;
    ...
    int64_t x = (c1 * b2 - b1 * c2) / det;
    int64_t y = (a1 * c2 - c1 * a2) / det;
